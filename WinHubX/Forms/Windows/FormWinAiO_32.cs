...
{
    public partial class FormWinAiO_32 : Form
    {
        private Form1 form1;
        private FormWin formWin;
        private NotifyIcon notifyIcon;
        public FormWinAiO_32(FormWin formWin, Form1 form1)
        {
            InitializeComponent();
            this.form1 = form1;
        ...
        private void FormWinAiO_Load(object sender, EventArgs e)
        {
        ...
        private void btnWinAIO32_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Right)
            {

                Clipboard.SetText("HASH CODE AIO32");
