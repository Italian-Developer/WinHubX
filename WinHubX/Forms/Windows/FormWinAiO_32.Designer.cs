namespace WinHubX.Forms.Windows
{
    partial class FormWinAiO_32
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnWinAIO32 = new Button();
            lblWinAIO32 = new Label();
            btnBack = new Button();
            lblInfoWinStock32 = new Label();
            lblInfoWinLite32 = new Label();
            btnInfoWin7Lite = new Label();
            btnInfoWin8dot1Lite = new Label();
            btnInfoWin10Lite = new Label();
            lblInfoWinAIO32 = new Label();
            ...
            btnWinAIO32.UseVisualStyleBackColor = true;
            btnWinAIO32.MouseUp += btnWinAIO32_MouseUp;
            // 
            // lblWinAIO32
            // 
            ...
            Controls.Add(lblWinAiO);
            Controls.Add(pictureBox3);
            Controls.Add(pictureBox2);
            Controls.Add(pictureBox1);
            Controls.Add(lblInfoWinAIO32);
            Controls.Add(btnInfoWin10Lite);
            Controls.Add(btnInfoWin8dot1Lite);
            Controls.Add(btnInfoWin7Lite);
            Controls.Add(lblInfoWinLite32);
            Controls.Add(lblInfoWinStock32);
            Controls.Add(lblHashInfo);
            Controls.Add(btnWinAIO32);
        ...
        private Label lblInfoWinAIO32;
        private Button btnWinAIO32;
        private Label lblWinAIO32;
        private Button btnBack;
        private Label lblInfoWinStock32;
        private Label lblInfoWinLite32;
